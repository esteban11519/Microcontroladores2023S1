...
#define _XTAL_FREQ 4000000 // Fosc = 4MHz; define before of LibLCDXC8.h
#include "LibLCDXC8.h"
...
//#pragma config FOSC=EC_EC 	/*Generator oscillator 1 MHz */
#pragma config FOSC=HS 	/*Crystal oscillator 4 MHz */
